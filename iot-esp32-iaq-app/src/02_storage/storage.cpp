...
constexpr char STORAGE_KEY_CLAIMED[] = "claimed";
...
bool Storage::loadDeviceClaimed() {
    return get(STORAGE_DEVICE_NAMESPACE, STORAGE_KEY_CLAIMED, false);
}

bool Storage::saveDeviceClaimed(bool p_claimed) {
    return put(STORAGE_DEVICE_NAMESPACE, STORAGE_KEY_CLAIMED, p_claimed);
}
