...
public:
    ...
    // Probes the PCF8563 on the I2C bus. p_wire must wrap `Wire`, already begun and clocked by
    // main; it's injected (rather than begun here) so main owns the shared bus's lifecycle.
    void init(WireWrapper& p_wire);
